...
<div class="row">
	<div class="col-xs-12">
		<div class="description">
			...
			<div class="row">
				<div class="col-xs-4">
					<img src="img/NS_00220_CodFillets8oz_300x300pixels.jpg" width="300" height="300" alt="NS 00220 CodFillets8oz 300x300pixels">
					<img src="img/NS_Web_Nutrition Panels21.jpg" width="216" height="522" alt="NS Web Nutrition Panels21">
				</div>
				<div class="col-xs-8">
					<h3>Premium Cod Fillets with Multigrain Breading, 8oz</h3>
					<p>Ingredients:<br>
						Cod, breading (organic unbleached wheat flour, organic whole wheat flour, canola oil&#8727;, water, contains less than 2% of the following: organic cornmeal, sea salt, arrowroot starch, spices, onion powder, yeast, salt, garlic powder, wheat bran).<br>
						Contains: Fish (cod), wheat.<br>
