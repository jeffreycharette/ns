...
<div class="row">
	<div class="col-xs-12">
		<div class="description">
			...
			<div class="row">
				<div class="col-xs-4">
					<img src="img/NS_00784_TongolTunaSaltedFDSRVC_300x300pixels.jpg" width="300" height="300" alt="NS 00784 TongolTunaSaltedFDSRVC 300x300pixels">
					<img src="img/NS_Web_Nutrition Panels10.jpg" width="216" height="522" alt="NS Web Nutrition Panels10">
				</div>
				<div class="col-xs-8">
					<h3>Chunk Light Tongol Tuna, Salted, 66.3oz</h3>
					<p>Ingredients:<br>
						Tongol tuna, spring water, sea salt.<br>
						Contains: Fish.</p>
					<div class="symbols">
