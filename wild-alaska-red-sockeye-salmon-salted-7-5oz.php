...
<div class="row">
	<div class="col-xs-12">
		<div class="description">
			...
			<div class="row">
				<div class="col-xs-4">
					<img src="img/NS_01307_RedSockeyeSalmonSalted_300x300pixels.jpg" width="300" height="300" alt="NS 01307 RedSockeyeSalmonSalted 300x300pixels">
					<img src="img/NS_Web_Nutrition Panels18.jpg" width="216" height="522" alt="NS Web Nutrition Panels18">
				</div>
				<div class="col-xs-8">
					<h3>Wild Alaska Red Sockeye Salmon, Salted, 7.5oz</h3>
					<p>Ingredients:<br>
						Wild Alaska red sockeye salmon, salt.<br>
						Contains: Fish.<br>
						May contain bones.</p>
					<div class="symbols">
