...
<div class="row">
	<div class="col-xs-12">
		<div class="description">
			...
			<div class="row">
				<div class="col-xs-4">
					<img src="img/NS_00783_TongolTunaNoSaltFDSRVC_300x300pixels.jpg" width="300" height="300" alt="NS 00783 TongolTunaNoSaltFDSRVC 300x300pixels">
					<img src="img/NS_Web_Nutrition Panels11.jpg" width="216" height="522" alt="NS Web Nutrition Panels11">
				</div>
				<div class="col-xs-8">
					<h3>Tongol Tuna, No Salt Added, Foodservice</h3>
					<p>Ingredients:<br>
						Tongol tuna, spring water.<br>
						Contains fish.</p>
					<div class="symbols">
