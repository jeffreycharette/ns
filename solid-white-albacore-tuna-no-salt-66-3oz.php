...
<div class="row">
	<div class="col-xs-12">
		<div class="description">
			...
			<div class="row">
				<div class="col-xs-4">
					<img src="img/NS_00786_AlbacoreNoSaltFDSRVC_300x300pixels.jpg" width="300" height="300" alt="NS 00786 AlbacoreNoSaltFDSRVC 300x300pixels">
					<img src="img/NS_Web_Nutrition Panels9.jpg" width="216" height="522" alt="NS Web Nutrition Panels9">
				</div>
				<div class="col-xs-8">
					<h3>Solid White Albacore Tuna, No Salt Added, 66.3oz</h3>
					<p>Ingredients:<br>
