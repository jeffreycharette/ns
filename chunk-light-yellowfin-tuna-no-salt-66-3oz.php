...
<div class="row">
	<div class="col-xs-12">
		<div class="description">
			...
			<div class="row">
				<div class="col-xs-4">
					<img src="img/NS_00625_YellowfinNoSaltFDSRV_300x300pixels.jpg" width="300" height="300" alt="NS 00625 YellowfinNoSaltFDSRV 300x300pixels">
					<img src="img/NS_Web_Nutrition Panels13.jpg" width="216" height="522" alt="NS Web Nutrition Panels13">
				</div>
				<div class="col-xs-8">
					<h3>Chunk Light Yellowfin Tuna, No Salt Added, 66.3oz</h3>
					<p>Ingredients:<br>
						Yellowfin tuna, spring water.<br>
						Contains: Fish.</p>
					<div class="symbols">
