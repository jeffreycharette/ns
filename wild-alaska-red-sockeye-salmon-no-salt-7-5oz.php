...
<div class="row">
	<div class="col-xs-12">
		<div class="description">
			...
			<div class="row">
				<div class="col-xs-4">
					<img src="img/NS_01308_RedSockeyeSalmonNoSalt_300x300pixels.jpg" width="300" height="300" alt="NS 01308 RedSockeyeSalmonNoSalt 300x300pixels">
					<img src="img/NS_Web_Nutrition Panels19.jpg" width="216" height="522" alt="NS Web Nutrition Panels19">
				</div>
				<div class="col-xs-8">
					<h3>Wild Alaska Red Sockeye Salmon, No Salt Added, 7.5oz</h3>
					<p>Ingredients:<br>
						Wild Alaska red sockeye salmon.<br>
						Contains: Fish.<br>
						May contain bones.</p>
					<div class="symbols">
